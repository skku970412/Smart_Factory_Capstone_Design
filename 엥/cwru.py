...
class CWRU:
    def __init__(self, exps, rpms, length):
        ...
        print(rdir,exp,rpm)
        fmeta = os.path.join(os.path.abspath(os.path.dirname(__file__)), 'metadata.txt')
...
if __name__ == "__main__":
    ...
    length = 1024
    cwru = CWRU(exps, rpms, length)
    print("Training data shape: ", cwru.X_train.shape)
    print("Test data shape: ", cwru.X_test.shape)
    print("Number of classes: ", cwru.nclasses)